<?php
class DscRcgGlobals{
    public $NroLinDR; //Número de descuento o recargo. De 1 a 20.
    public $TpoMov; //D(descuento) o R(recargo) 
    public $GlosaDR; //Especificación de descuento o recargo 
    public $TpoValor; //Indica si es Porcentaje o Monto 
    public $ValorDR; //Valor del descuento o recargo en 16  enteros y 2 decimales
    public $IndExeDR; //Indica si el descuento o recargo afecta a ítems exentos o no afectos a IVA.

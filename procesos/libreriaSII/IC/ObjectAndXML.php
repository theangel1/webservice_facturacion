...
class ObjectAndXML {
	...
	public function __construct($idic, $rutEmpresa="") {
		...
		$this->xml->openMemory();
                ...
                touch("/home/netdte/public_html/procesos/xml_respuestas/$rutEmpresa/$idic.xml");

                $uri = realpath("/home/netdte/public_html/procesos/xml_respuestas/$rutEmpresa/$idic.xml");
